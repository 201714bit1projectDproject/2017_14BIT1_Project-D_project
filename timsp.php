...
<div id="wrapper">
  ...
  if (isset($_GET['q']) && !empty($_GET['q'])) {
      ...
      $caulenh="select * from products where ProductName LIKE '%$keyword%'";
          ...
          <tr>
              <td>
                  <form action="" method ="get">
                      ...
                      <input type="button" class=button3 value="tat ca" onclick="window.location.href='/mobile/admin/quanlysp.php'"/>
                  </form>
                </td>
            </tr>
          </table>
...
<a href = "quanlysp.php" class="button3">Quay Lai  </a>
